...
STRINGS = {
    ...
    "menu.lab": {"es": "Laboratorio", "en": "Laboratory"},
    "menu.tools": {"es": "Herramientas", "en": "Tools"},
    "menu.system": {"es": "Sistema", "en": "System"},
    "menu.term": {"es": "Terminal", "en": "Terminal"},
    "menu.ide": {"es": "IDE", "en": "IDE"},
    "term.presets": {"es": "Presets de terminal", "en": "Terminal presets"},
    "term.banner": {"es": "Banner de inicio", "en": "Login banner"},
    "term.prompt": {"es": "Prompt de fish", "en": "Fish prompt"},
    "term.shell": {"es": "Configuración de shell", "en": "Shell configuration"},
    "term.save": {"es": "Guardar mi config como preset", "en": "Save my config as preset"},
    "term.edit": {"es": "Editar configuración instalada", "en": "Edit installed config"},
    "term.set_ok": {"es": "Preset '{preset}' aplicado", "en": "Preset '{preset}' applied"},
    "term.banner_ok": {"es": "Banner '{style}' activado", "en": "Banner '{style}' enabled"},
    "term.prompt_ok": {"es": "Prompt '{style}' activado", "en": "Prompt '{style}' enabled"},
    "term.shell_ok": {"es": "Shell '{style}' aplicado", "en": "Shell '{style}' applied"},
    "term.saved": {"es": "Preset '{name}' guardado", "en": "Preset '{name}' saved"},
    "term.choose_preset": {"es": "Elige un preset de terminal", "en": "Choose a terminal preset"},
    "term.choose_banner": {"es": "Elige el banner de inicio", "en": "Choose the login banner"},
    "term.choose_prompt": {"es": "Elige el prompt", "en": "Choose the prompt"},
    "term.choose_shell": {"es": "Elige la config de shell", "en": "Choose the shell config"},
    "term.save_name": {"es": "Nombre del nuevo preset", "en": "New preset name"},
    "ide.install_ok": {"es": "IDE '{preset}' instalado", "en": "IDE '{preset}' installed"},
    "ide.backup_ok": {"es": "Respaldo creado: {path}", "en": "Backup created: {path}"},
    "ide.choose_preset": {"es": "Elige un preset de IDE", "en": "Choose an IDE preset"},
    "ide.edit": {"es": "Editar configuración del IDE", "en": "Edit IDE config"},
    "ide.backup": {"es": "Respaldar config del IDE", "en": "Backup IDE config"},
    "choose_style": {"es": "Elige un estilo", "en": "Choose a style"},
    "list.tools_count": {
